...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-fe-_$5l(0qen&j_1md8#qp@pl44@^+(8lu%=iae1kx6*fyur48')
...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'https://mvp.rondira.com,http://localhost:3000').split(',')
...
SIMPLE_JWT = {
    ...
    'AUTH_COOKIE_SECURE': os.getenv('DEBUG', 'True') == 'False',
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Mvp Inmobiliaria <soporte@mvp.rondira.com>')
